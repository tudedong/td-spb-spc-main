...
import com.td.common.config.ConfigServerDruid;
import com.td.common.enums.DataSourceType;
import com.td.framework.config.properties.DruidProperties;
import com.td.framework.datasource.DynamicDataSource;

import lombok.extern.slf4j.Slf4j;

/**
 * @author tudedong
 * @description druid 配置多数据源和sql监控服务
