package com.td.api.provider.aop;
...
import com.td.api.provider.util.RequestUtil;
...
public class LogAspect {
	...
	@Pointcut("@annotation(com.td.api.provider.aop.LogAnnotation)")
	...
	public void doAfterThrowing(JoinPoint joinPoint, Throwable ex) {
		...
		for (int i = 0; i < ex.getStackTrace().length; i++) {
			...
			if (stackTraceElement.getClassName().startsWith("com.td")) {
